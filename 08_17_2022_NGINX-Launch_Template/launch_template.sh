...
18. Select `MytestTemplate` ---> `Actions` ---> `Launch Instance from Template`
...
23. Select template named `MytestTemplate` ---> `Actions` ---> `Modify template (Create New Version)`
...
28. Go to `Launch Template` Menu and click on `MytestTemplate`.
...
35. Select template named `MytestTemplate` ---> `Actions` ---> 'Modify template (Create New Version)'.
...
40. Go to `Launch Template` Menu and click on `MytestTemplate`.
