...
# Connect the testdb on MariaDB Server on the other EC2 instance (pw:test1234).
mysql -h ec2-3-94-163-77.compute-1.amazonaws.com -u testuser -p

# Show that testuser can do same db operations on MariaDB Server instance.
SHOW DATABASES;
USE testdb;
SHOW TABLES;
